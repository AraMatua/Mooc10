...
class Game {
    ...
    constructor () {
        ...
        this.boss = undefined; // Instancia del jefe del juego
        this.bossShots = []; // Disparos del jefe
    ...
    endGame () {
        ...
        {
            message = GAME_OVER_PICTURE;
        }
        let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, message);
        gameOver.render();
    }
